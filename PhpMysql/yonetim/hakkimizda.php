<?php
    ...
    if ($_POST) {
        ...
        $sorgu = $baglan->query("insert into hakkımızda (aciklama) values ('$aciklama')");
...
<body style="text-align:center;">
    ...
    <form action="" method="post">
        <b>ust_baslik:</b><br><br>
        <textarea style="width:80%;height:100px;" name="ust_baslik"><?php echo $satir->ust_baslik; ?></textarea><br><br>
